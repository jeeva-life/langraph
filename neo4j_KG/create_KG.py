...
#Gather the data
DOCS_PATH = "NEO4J_KG/data/course/pdfs"
...
doc_transformer = LLMGraphTransformer(
    ...
    #allowed_relationships=["USES", "HAS", "IS", "AT", "KNOWS"]    #You can also restrict the relationships by specifying the allowed_relationships parameter.
